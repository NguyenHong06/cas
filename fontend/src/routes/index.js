...
// Cardinfos components
const Information = async(() => import("../pages/cardinfos/Information"));
// const Informations = async(() => import("../pages/cardinfos/Default"));
// const AnalyticsInformations = async(() => import("../pages/cardinfos/Analytics"));
...
// Product components
const ProductList = async(() => import("../pages/product/ProductList"));
